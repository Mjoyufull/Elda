...
use crate::model::{
    DependencyEntry, IssueSeverity, PackageDefinition, RecipeDocument, ValidationIssue,
};
...
fn validate_package(package: &PackageDefinition, issues: &mut Vec<ValidationIssue>) {
    ...
    validate_dependencies("depends", &package.depends, issues);
    validate_dependencies("makedepends", &package.makedepends, issues);
    validate_dependencies("checkdepends", &package.checkdepends, issues);
    validate_dependencies("recommends", &package.recommends, issues);
    validate_dependencies("suggests", &package.suggests, issues);
    validate_dependencies("supplements", &package.supplements, issues);
    validate_dependencies("enhances", &package.enhances, issues);
