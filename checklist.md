...
- [x] Current slice — pkgit parity audit is reconciled, hosted `ci pr` auth supports bearer tokens, and system activation snapshots support direct `btrfs` alongside `snapper`
