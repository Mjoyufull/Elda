...
- Pre-Phase-11+ native CLI slice remains closed for named runtime surfaces, while `prephase11+.md` keeps the UX polish ledger at roughly **97%/98%** to avoid claiming full CLI completeness.
