...
- **Pre-Phase-11+ focus:** **100%** for the named native CLI/UX slice (runtime-backed surfaces plus listed post-prephase polish). Phase-11 interepo/coexistence remains separate.
- **Post-prephase polish (same milestone, not Phase 11):** **100%** for ledger-listed items.
